...
public abstract class GenericSRIServiceImpl<DTO extends ComprobanteDTO, MODEL extends Comprobante, DOMAIN extends BaseSRIEntity>
    ...
    private RespuestaComprobanteDTO applyReceipt(String claveAcceso) throws ResourceNotFoundException, VeronicaException {
	 ...
	 System.out.println("PROXY: "+proxy.toString());
        ...
        System.out.println("GETAUTORIZACION: "+respuestaComprobante.getAutorizaciones());
 ...
 //	List<Autorizacion> auth = respuestaComprobante.getAutorizaciones().getAutorizacion();
	...
	RespuestaComprobanteDTO respuestaComprobanteDTO = null;
//	System.out.println("RESPUESTASRI: "+respuestaComprobante);
	try{
		 System.out.println("ESTOY DENTRO DEL TRY ");
		respuestaComprobanteDTO = respuestaComprobanteMapper.convert(respuestaComprobante);
	}catch(NullPointerException e){
	System.out.println("RESPUESTACOMPROBANTEERROR: "+ e.toString());
	}
